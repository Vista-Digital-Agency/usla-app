...
/***/ "./node_modules/@ionic/core/dist/esm/es2017/build/psxwmesv.sc.entry.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es2017/build/psxwmesv.sc.entry.js ***!
  \*****************************************************************************/
...
class Modal {
    ...
    async present() {
        ...
        return Object(_chunk_4f24dff4_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation);
    }
    async dismiss(data, role) {
        const dismissed = await Object(_chunk_4f24dff4_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation);
        if (dismissed) {
    ...
    onDidDismiss() {
        return Object(_chunk_4f24dff4_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionModalDidDismiss');
    }
    onWillDismiss() {
        return Object(_chunk_4f24dff4_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionModalWillDismiss');
    }
    hostData() {
        return {
            'no-router': true,
...
class ModalController {
    create(opts) {
        return Object(_chunk_4f24dff4_js__WEBPACK_IMPORTED_MODULE_1__["f"])(this.doc.createElement('ion-modal'), opts);
    }
    dismiss(data, role, id) {
        return Object(_chunk_4f24dff4_js__WEBPACK_IMPORTED_MODULE_1__["g"])(this.doc, data, role, 'ion-modal', id);
    }
    async getTop() {
        return Object(_chunk_4f24dff4_js__WEBPACK_IMPORTED_MODULE_1__["h"])(this.doc, 'ion-modal');
    }
